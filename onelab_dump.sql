...
COPY public.book_borrows (id, book_id, user_id, borrow_date, return_date, version, uuid) FROM stdin;
4	1	1	2020-04-17 18:25:43.511	\N	1	1ecf4c82-d577-4283-b038-31c84d0cf0dc
\.
...
COPY public.books (id, title, author, version, price) FROM stdin;
1	aboba	aboba	1	100
\.
...
1	aboba	aboba	$2a$14$agNoXcrtj2.nsOsLWAq1S.DHk6bvOGXnEykYzWd4y8wCahILSTLFm	f	1
\.
...
SELECT pg_catalog.setval('public.book_borrows_id_seq', 4, true);
